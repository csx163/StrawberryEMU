...
void SmartScript::FillScript(SmartAIEventList e, WorldObject* obj, AreaTriggerData const* at)
{
    if (e.empty())
    {
        if (obj)
...
void SmartScript::OnInitialize(WorldObject* obj, AreaTriggerData const* at)
{
