...
class SmartScript
{
    public:
        ...
        void OnInitialize(WorldObject* obj, AreaTriggerData const* at = NULL);
        void GetScript();
        void FillScript(SmartAIEventList e, WorldObject* obj, AreaTriggerData const* at);
