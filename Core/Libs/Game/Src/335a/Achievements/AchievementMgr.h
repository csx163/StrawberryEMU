...
typedef std::list<AchievementCriteriaData const*> AchievementCriteriaDataList;
typedef std::list<AchievementData const*>         AchievementDataList;

typedef std::map<uint32, AchievementCriteriaDataList> AchievementCriteriaListByAchievement;
typedef std::map<uint32, AchievementDataList>         AchievementListByReferencedId;
...
struct AchievementCriteriaData2
{
    ...
    AchievementCriteriaData2() : dataType(ACHIEVEMENT_CRITERIA_DATA_TYPE_NONE)
    {
        raw.value1 = 0;
        raw.value2 = 0;
        ScriptId = 0;
    ...
    AchievementCriteriaData2(uint32 _dataType, uint32 _value1, uint32 _value2, uint32 _scriptId) : dataType(AchievementCriteriaDataType(_dataType))
    {
        raw.value1 = _value1;
        raw.value2 = _value2;
        ScriptId = _scriptId;
    ...
    bool IsValid(AchievementCriteriaData const* criteria);
...
struct AchievementCriteriaDataSet
{
        ...
        typedef std::vector<AchievementCriteriaData2> Storage;
        void Add(AchievementCriteriaData2 const& data) { storage.push_back(data); }
...
class AchievementMgr
{
    public:
        ...
        bool HasAchieved(AchievementData const* achievement) const;
    ...
    private:
        ...
        void SendAchievementEarned(AchievementData const* achievement) const;
        void SendCriteriaUpdate(AchievementCriteriaData const* entry, CriteriaProgress const* progress, uint32 timeElapsed, bool timedCompleted) const;
        CriteriaProgress* GetCriteriaProgress(AchievementCriteriaData const* entry);
        void SetCriteriaProgress(AchievementCriteriaData const* entry, uint32 changeValue, ProgressType ptype = PROGRESS_SET);
        void RemoveCriteriaProgress(AchievementCriteriaData const* entry);
        void CompletedCriteriaFor(AchievementData const* achievement);
        bool IsCompletedCriteria(AchievementCriteriaData const* achievementCriteria, AchievementData const* achievement);
        bool IsCompletedAchievement(AchievementData const* entry);
        bool CanUpdateCriteria(AchievementCriteriaData const* criteria, AchievementData const* achievement);
...
class AchievementGlobalMgr
{
    ...
    public:
        AchievementCriteriaDataList const& GetAchievementCriteriaByType(AchievementCriteriaTypes type) const
        {
            return m_AchievementCriteriasByType[type];
        }

        AchievementCriteriaDataList const& GetTimedAchievementCriteriaByType(AchievementCriteriaTimedTypes type) const
        {
            return m_AchievementCriteriasByTimedType[type];
        }

        AchievementCriteriaDataList const* GetAchievementCriteriaByAchievement(uint32 id) const
        {
            AchievementCriteriaListByAchievement::const_iterator itr = m_AchievementCriteriaListByAchievement.find(id);
            return itr != m_AchievementCriteriaListByAchievement.end() ? &itr->second : NULL;
        }

        AchievementDataList const* GetAchievementByReferencedId(uint32 id) const
        {
            AchievementListByReferencedId::const_iterator itr = m_AchievementListByReferencedId.find(id);
            return itr != m_AchievementListByReferencedId.end() ? &itr->second : NULL;
        }

        AchievementReward const* GetAchievementReward(AchievementData const* achievement) const
        {
        ...
        AchievementRewardLocale const* GetAchievementRewardLocale(AchievementData const* achievement) const
        {
        ...
        AchievementCriteriaDataSet const* GetCriteriaDataSet(AchievementCriteriaData const *achievementCriteria) const
        {
            AchievementCriteriaDataMap::const_iterator iter = m_criteriaDataMap.find(achievementCriteria->Id);
            return iter != m_criteriaDataMap.end() ? &iter->second : NULL;
        }

        bool IsRealmCompleted(AchievementData const* achievement) const
        {
            return m_allCompletedAchievements.find(achievement->Id) != m_allCompletedAchievements.end();
        }

        void SetRealmCompleted(AchievementData const* achievement)
        {
    ...
    private:
        ...
        AchievementCriteriaDataList m_AchievementCriteriasByType[ACHIEVEMENT_CRITERIA_TYPE_TOTAL];
        AchievementCriteriaDataList m_AchievementCriteriasByTimedType[ACHIEVEMENT_TIMED_TYPE_MAX];
