...
void SpellMgr::LoadSpellAreas()
{
    ...
    do
    {
        ...
        if (spellArea.areaId && !sObjectMgr->GetAreaTableData(spellArea.areaId))
        {
...
SpellCastResult SpellMgr::GetSpellAllowedInLocationError(SpellEntry const *spellInfo, uint32 map_id, uint32 zone_id, uint32 area_id, Player const* player)
{
    ...
    {
        bool found = false;
        AreaGroupData const* groupEntry = sObjectMgr->GetAreaGroupData(spellInfo->AreaGroupId);
        while (groupEntry)
        {
            ...
            groupEntry = sObjectMgr->GetAreaGroupData(groupEntry->NextGroup);
        }
        ...
        case 58600: // No fly Zone - Dalaran
            {
                ...
                AreaTableData const* pArea = sObjectMgr->GetAreaTableData(player->GetAreaId());
