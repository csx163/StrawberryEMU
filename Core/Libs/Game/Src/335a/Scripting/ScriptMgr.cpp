...
bool ScriptMgr::OnAreaTrigger(Player* player, AreaTriggerData const* trigger)
{
    ASSERT(player);
    ASSERT(trigger);
...
bool ScriptMgr::OnCriteriaCheck(AchievementCriteriaData2 const* data, Player* source, Unit* target)
{
    ASSERT(source);
    // target can be NULL.
