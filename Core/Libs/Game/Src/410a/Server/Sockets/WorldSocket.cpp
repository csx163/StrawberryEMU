...
int WorldSocket::HandleAuthSession (WorldPacket& recvPacket)
{
    ...
    // Get the account information from the RealmServer database
    ...
    ///- Re-check ip locking (same check as in RealmServer).
    ...
    // Re-check account ban (same check as in RealmServer)
