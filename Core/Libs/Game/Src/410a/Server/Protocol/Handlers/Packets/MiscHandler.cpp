...
void WorldSession::SendSetPhaseShift(uint32 phaseType, uint16 mapId)
{
    uint8 questType   = 0;
    uint8 terrainType = 2;
    WorldPacket data(SMSG_SET_PHASE_SHIFT, 4);    // Max size in dump was 36 (terrain and quest phase change???).
