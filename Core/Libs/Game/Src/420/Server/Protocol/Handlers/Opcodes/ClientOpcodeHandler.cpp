...
void ClientOpcodeTable()
{
    ...
    // Chat Message
    CLIENTOPCODE(CMSG_MESSAGECHAT,                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode);
    ...
    CLIENTOPCODE(CMSG_GET_MIRRORIMAGE_DATA,              STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleMirrorImageDataRequest );
