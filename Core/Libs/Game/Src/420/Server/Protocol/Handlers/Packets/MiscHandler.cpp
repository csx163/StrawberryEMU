...
void WorldSession::HandleInspectHonorStatsOpcode(WorldPacket& recv_data)
{
    ...
    data << uint32(player->GetUInt32Value(uint32(0)));//PLAYER_FIELD_TODAY_CONTRIBUTION));
    data << uint32(player->GetUInt32Value(uint32(0)));//PLAYER_FIELD_YESTERDAY_CONTRIBUTION));
