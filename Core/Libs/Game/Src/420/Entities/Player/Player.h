...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void SetInGuild(uint32 GuildId) { GuildId = 0; }//SetUInt32Value(PLAYER_GUILDID, GuildId); }
        void SetRank(uint8 rankId) { SetUInt32Value(PLAYER_GUILDRANK, rankId); }
        uint8 GetRank() { return uint8(GetUInt32Value(PLAYER_GUILDRANK)); }
        void SetGuildIdInvited(uint32 GuildId) { m_GuildIdInvited = GuildId; }
        uint32 GetGuildId() { return GetUInt32Value(uint32(0));  }
        ...
        uint32 GetHonorPoints() const { return GetUInt32Value(uint32(0)); }
        uint32 GetArenaPoints() const { return GetUInt32Value(uint32(0)); }
