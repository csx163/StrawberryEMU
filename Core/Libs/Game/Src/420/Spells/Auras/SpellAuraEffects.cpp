...
// such checks will speedup change amount/send for client operations
            ...
            switch (GetSpellProto()->Id)
            {
                ...
                case 51690:
                {
                    ...
                    UnitList targets;
                    {
                        ...
                        Strawberry::AnyUnfriendlyAttackableVisibleUnitInObjectRangeCheck u_check(target, target, radius);
