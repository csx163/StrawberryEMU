...
enum ServerOpcodes
{
    ...
    /***********************************************************/
    SMSG_AUTH_SRP6_RESPONSE                              = 0x0039,    // 57    - 4.0.6.13623
    ...
    SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                    = 0xE5E8,    // 58856 - 4.0.6.13623
    ...
    SMSG_BATTLEFIELD_MGR_STATE_CHANGE                    = 0x352D,    // 13613 - 4.0.6.13623
    SMSG_BATTLEFIELD_LIST                                = 0x23D,
    SMSG_BATTLEFIELD_WIN_OBSOLETE                        = 0x23F,
    SMSG_BATTLEFIELD_LOSE_OBSOLETE                       = 0x240,
    SMSG_BATTLEFIELD_STATUS                              = 0x454C,    // 17740 - 4.0.6.13623
    ...
    /********************** GUILD OPCODES **********************/
    /***********************************************************/
    SMSG_GUILD_INVITE                                    = 0x010C,    // 268   - 4.0.6.13623
    SMSG_GUILD_DECLINE                                   = 0x7DEC,    // 32236 - 4.0.6.13623
    SMSG_GUILD_INFO                                      = 0x20A8,    // 8360  - 4.0.6.13623
    SMSG_GUILD_ROSTER                                    = 0x4D5C,    // 19804 - 4.0.6.13623
    SMSG_GUILD_EVENT                                     = 0xB7C4,    // 47044 - 4.0.6.13623
    SMSG_GUILD_COMMAND_RESULT                            = 0x23C0,    // 9152  - 4.0.6.13623
    SMSG_GUILD_BANK_LIST                                 = 0x3E8,
    SMSG_GUILD_UPDATE_ROSTER                             = 0x085E,    // 2142  - 4.0.6.13623
    SMSG_GUILD_RANKS_UPDATE                              = 0x004C,    // 76    - 4.0.6.13623
    SMSG_GUILD_REWARDS_LIST                              = 0x0C4C,    // 3148  - 4.0.6.13623
    SMSG_GUILD_TRADESKILL_UPDATE                         = 0x454E,    // 17742 - 4.0.6.13623
    SMSG_GUILD_MAX_DAILY_XP                              = 0x441C,    // 17436 - 4.0.6.13623
    SMSG_GUILD_XP_UPDATE                                 = 0x440E,    // 17422 - 4.0.6.13623
    SMSG_GUILD_NEWS_UPDATE                               = 0x485E,    // 18526 - 4.0.6.13623
    SMSG_GUILD_RANK                                      = 0x411E,    // 16670 - 4.0.6.13623

    // Party
    SMSG_PARTY_MEMBER_STATS                              = 0x07E,
    SMSG_PARTY_COMMAND_RESULT                            = 0x26E0,    // 9952  - 4.0.6.13623
    SMSG_PARTY_MEMBER_STATS_FULL                         = 0xBA8C,    // 47756 - 4.0.6.13623
    SMSG_ECHO_PARTY_SQUELCH                              = 0x2AC4,    // 10948 - 4.0.6.13623

    // Petition
    SMSG_BUY_BANK_SLOT_RESULT                            = 0x1BA,
    SMSG_PETITION_SHOWLIST                               = 0xFCC0,    // 64704 - 4.0.6.13623
    SMSG_PETITION_SHOW_SIGNATURES                        = 0xE2E0,    // 58080 - 4.0.6.13623
    SMSG_PETITION_SIGN_RESULTS                           = 0xA1A4,    // 41380 - 4.0.6.13623
    SMSG_TURN_IN_PETITION_RESULTS                        = 0x35AC,    // 13740 - 4.0.6.13623
    ...
    SMSG_RAID_INSTANCE_MESSAGE                           = 0x2CD,
    ...
    // Battleground
    SMSG_GROUP_JOINED_BATTLEGROUND                       = 0x0D1E,    // 3358  - 4.0.6.13623
    SMSG_JOINED_BATTLEGROUND_QUEUE                       = 0x090E,    // 2318  - 4.0.6.13623
    ...
    SMSG_BATTLEGROUND_PLAYER_JOINED                      = 0x494C,    // 18764 - 4.0.6.13623
    SMSG_BATTLEGROUND_PLAYER_LEFT                        = 0x0D1C,    // 3356  - 4.0.6.13623
    ...
    SMSG_TRADE_STATUS                                    = 0x494E,    // 18766 - 4.0.6.13623
    SMSG_TRADE_STATUS_EXTENDED                           = 0x400C,    // 16396 - 4.0.6.13623
    ...
    SMSG_FORCE_SWIM_SPEED_CHANGE                         = 0xF5A0,    // 62880 - 4.0.6.13623
    SMSG_MOVE_KNOCK_BACK                                 = 0xB180,    // 45440 - 4.0.6.13623
    ...
    /***********************************************************/
    // Mount
    SMSG_MOUNTRESULT                                     = 0x2AEC,    // 10988 - 4.0.6.13623
    SMSG_DISMOUNTRESULT                                  = 0xF9C0,    // 63936 - 4.0.6.13623
    ...
    SMSG_CORPSE_NOT_IN_INSTANCE                          = 0x31E4,    // 12772 - 4.0.6.13623
    ...
    SMSG_ARENA_TEAM_ROSTER                               = 0xEC80,    // 60544 - 4.0.6.13623
    ...
    /********************* QUEST OPCODES ***********************/
    /***********************************************************/
    SMSG_QUESTLOG_FULL                                   = 0x61EC,    // 25068 - 4.0.6.13623
    ...
    SMSG_CAMERA_SHAKE                                    = 0x34A4,    // 13476 - 4.0.6.13623
    ...
    SMSG_TRAINER_BUY_RESULT                              = 0x6DEC,    // 28140 - 4.0.6.13623
    ...
    SMSG_ITEM_TIME_UPDATE                                = 0x66A4,    // 26276 - 4.0.6.13623
    ...
    SMSG_SHOW_BANK                                       = 0x27A4,    // 10148 - 4.0.6.13623
    ...
    SMSG_INVALID_PROMOTION_CODE                          = 0x69AC,    // 27052 - 4.0.6.133623
    SMSG_RWHOIS                                          = 0x1FE,
    ...
    SMSG_AREA_TRIGGER_MESSAGE                            = 0xEAE0,    // 60128 - 4.0.6.13623
    ...
    SMSG_UNKNOWN_1295                                    = 0xEDEC,    // 60908 - 4.0.6.13623
