...
bool StartDB()
{
    ...
    std::string dbstring = sConfig->GetStringDefault("RealmDBInfo", "");
    if (dbstring.empty())
    {
    ...
    uint8 worker_threads = sConfig->GetIntDefault("RealmDB.WorkerThreads", 1);
    ...
    uint8 synch_threads = sConfig->GetIntDefault("RealmDB.SynchThreads", 1);
